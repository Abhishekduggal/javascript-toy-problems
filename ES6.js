...
function insertion(arr) {
  ...
  //superSize(105) // 510
  //superSize(12) // 21
  // If the argument passed through is single digit or 
  //is already the maximum possible integer, your function 
...
// Write a function called songDecoder that removes the terrible 
//dubstep sounds from a song, to reveal the original, pure, un-dubstepped beauty.
...
function underToCamel(underName) {
  ...
  // In New York, the final bill is calculated as the price of the item, plus a 
  //3% shipping fee, plus a 9% sales tax assessed on the price of the item together with shipping costs.
  // In New Jersey, the final bill is calculated as the price of an item, 
  //plus a 5% shipping fee, plus a 7% sales tax assessed on the price of the item together with shipping costs.
